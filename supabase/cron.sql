...
-- ⚠️  Currently disabled — enable this once the app has users.
--
...
--   3. Uncomment the select cron.schedule(...) blocks below and run in SQL Editor.
--
-- Refreshes every Sunday at 3:00 AM UTC, staggered 5 min per category.
-- 100 questions per category (5 batches × 20) = 600 total.
